...
switch(_type) do
{
    ...
    case "902": {_type = ["Breaking Out A Prisoner",15500]};
	case "901": {_type = ["Escaping Jail",15500]};
    ...
    case "919A": {_type = ["Attempted Organ Theft",15000]};
    case "390": {_type = ["Public Intoxication",15000]};
    case "236": {_type = ["Human Trafficking",1000]};
