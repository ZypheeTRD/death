...
switch (_shop) do
{
	...
	case "rebel": {["Rebel Market",["water","rabbit","apple","redgull","tbacon","lockpick","pickaxe","fuelF","peach","boltcutter","blastingcharge","handcuffs","handcuffkeys","scalpel","organcooler"]]};
    ...
    case "blackmarket": {["Black Market",["handcuffs","handcuffkeys","organ","scalpel","organcooler"]]};
};