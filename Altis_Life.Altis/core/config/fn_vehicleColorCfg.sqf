...
switch (_vehicle) do
{
	...
	case "C_SUV_01_F":
	{
		...
		[
			...
			["textures\civ_suv_v2.jpg","civ"],
			["textures\civ_suv_v3.jpg","civ"],
			["textures\ferrari_suv.jpg","civ"],
			["textures\hk1.jpg","civ"]
		];
	};
		...
		case "B_Heli_Transport_01_F":
	{
		_ret = 
		[
			["textures\ghosthawk_police.jpg","cop"]
		];
	};	
	...
	case "B_MRAP_01_F":
	{
		...
		[
			...
			["textures\swat_hunter.jpg","cop","textures\swat_hunter_2.paa"],
			["textures\dea_hunter_1.paa","cop","textures\swat_hunter_2.paa"],
			["textures\medichunter_f.paa","med","textures\medichunter_b.paa"]
		];
	};
	...
	case "O_MRAP_02_F":
	{
		_ret = 
		[
			["textures\ifrit1.jpg","reb"],
			["textures\ifrit2.jpg","reb"],
			["textures\ifrit3.jpg","reb"],
			["textures\ifrit4.jpg","reb"],
			["textures\ifrit5.jpg","reb"],
			["textures\ifrit6.jpg","reb"]
		];
	};
	...
	case "I_Heli_light_03_unarmed_F":
	{
		_ret = 
		[
			["textures\blackcat.jpg","civ"],
			["textures\blackcat.jpg","reb"]
		];
	};
