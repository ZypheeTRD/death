...
switch (_mode) do
{
	case 0:
	{
		switch (_type) do
		{
			...
			case "attorney": {_var = "license_civ_attorney"};
			case "bhunter": {_var = "license_civ_bhunter"};
			case "adacair": {_var = "license_adac_air"};
			case "adaccar": {_var = "license_adac_car"};
			case "adacassassin": {_var = "license_adac_assassin"};
            case "liquor": {_var = "license_civ_liquor"};
			case "wine": {_var = "license_civ_liquor"};
			case "beer": {_var = "license_civ_liquor"};
			case "stiller": {_var = "license_civ_stiller"};
			case "whiskey": {_var = "license_civ_stiller"};
			case "tequila": {_var = "license_civ_stiller"};
			case "vodka": {_var = "license_civ_stiller"};
			case "moonshine": {_var = "license_civ_stiller"};
			case "mash": {_var = "license_civ_stiller"};
			case "wort": {_var = "license_civ_stiller"};
			...
			case "bottledwine": {_var = "license_civ_bottler"};
			case "bottledtequila": {_var = "license_civ_bottler"};
			case "bottledvodka": {_var = "license_civ_bottler"};
	...
	case 1:
	{
		switch (_type) do
		{
			...
			case "license_civ_attorney": {_var = "attorney"};
			case "license_civ_bhunter": {_var = "bhunter"};
			case "license_adac_air": {_var = "adacair"};
			case "license_adac_car": {_var = "adaccar"};
			case "license_adac_assassin": {_var = "adacassassin"};
            case "license_civ_liquor": {_var = "liquor"};
			case "license_civ_liquor": {_var = "beer"};
			case "license_civ_liquor": {_var = "wine"};
			case "license_civ_stiller": {_var = "stiller"};
			case "license_civ_stiller": {_var = "whiskey"};
			case "license_civ_stiller": {_var = "tequila"};
			case "license_civ_stiller": {_var = "vodka"};
			case "license_civ_stiller": {_var = "moonshine"};
			case "license_civ_stiller": {_var = "mash"};
			case "license_civ_stiller": {_var = "wort"};
			...
			case "license_civ_bottler": {_var = "bottledwine"};
			case "license_civ_bottler": {_var = "bottledtequila"};
			case "license_civ_bottler": {_var = "bottledvodka"};
