...
switch (_filter) do
{
	...
	case 0:
	{
		[
			...
			["U_O_FullGhillie_lsh",nil,20000],
			["U_O_FullGhillie_sard",nil,20000],
			["U_O_FullGhillie_ard",nil,20000],
	...
	case 3:
	{
		[
			...
			["V_PlateCarrierGL_mtp",nil,5500],
			["V_PlateCarrierGL_blk",nil,5500],
