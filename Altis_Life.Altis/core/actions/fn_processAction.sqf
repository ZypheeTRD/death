...
_itemInfo = switch (_type) do
{
	...
	case "heroin": {["heroinu","heroinp",2100,"Cutting Heroin's Potency",false]};
	...
	case "cocaine": {["cocaine","cocainep",1500,"Cutting Cocaine's Purity",false]};
	...
	case "wort": {["water","wort",100,"Mixing Wort",true,"potato"]};//new
	case "whiskey": {["yeast","whiskey",1000,"Fermenting Whiskey",true,"rye"]};//new
	case "beer": {["yeast","beerp",1500,"Brewing Beer",true,"hops"]};//new
	case "vodka": {["yeast","vodka",100,"Mixing Grain Mash",true,"wort"]};//new
	case "tequila": {["agave","tequila",1500,"Fermenting Tequila",true,"yeast"]};//new
	case "moonshine": {["yeast","moonshine",250,"Moonshining",true,"mash"]};//new
	case "wine": {["grapes","wine",1500,"Fermenting Wine",true,"yeast"]};//new
	case "bottledvodka": {["vodka","bottledvodka",500,"Bottle Vodka",true,"bottles"]};//new
	...
	case "bottledtequila": {["tequila","bottledtequila",500,"Bottle Tequila",true,"bottles"]};//new
	case "bottledwine": {["wine","bottledwine",500,"Bottle Moonshine",true,"bottles"]};//new
    default {[]};
};
