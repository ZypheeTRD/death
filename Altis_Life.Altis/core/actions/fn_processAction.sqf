...
_itemInfo = switch (_type) do
{
	...
	case "salt": {["salt","salt_r",450,"Grinding Salt"]};
	case "cocaine": {["cocaine","cocainep",1500,"Making Cocaine"]};
	case "marijuana": {["cannabis","marijuana",500,"Drying and Bagging Marijuana"]};
	case "joint": {["marijuana","joint",500,"Rolling a Fat Joint"]};
	case "heroin": {["heroinu","heroinp",1720,"Decreasing Potency and Bagging Heroin"]};
	case "meth": {["methu","methp",550,"Cutting and Bagging Meth"]};
	case "krok": {["kroku","krokp",1500,"Bagging Krokodil"]};
	case "cement": {["rock","cement",350,"Mixing Cement"]};
	case "cement": {["rock","cement",1350,"Mixing Cement"]};
	case "bottles": {["glass","bottles",1350,"Making Bottles"]};
	case "cigarettes": {["tobacco","cigarettes",1350,"Rolling Cigarettes"]};
	case "cornmeal": {["corn","cornmeal",1350,"Making Cornmeal"]};
	default {[]};
};
