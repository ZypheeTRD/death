...
_chance = random(100);
if(_chance >= 55) then { hint "The cashier hit the silent alarm, police have been alerted!"; [[1,format["ALARM! - Store: %1 is being robbed!", _shop]],"life_fnc_broadcast",west,false] spawn life_fnc_MP; };
