...
_FuelStuff = ["oilu","oilp","ethanol","fuelF","milk","applejuice","orangejuice","grapejuice","nwaste","moonshine","beerp","vodka","tequila","wine","whiskey"]; //Wich Items can be stored in?
...
if (life_TankLaster == 3) exitWith {hint "Ey boy!! That won't pass through the nozzle! (Fuel Trucks can only store liquids!)"};
if (life_TankLaster == 4) exitWith {hint "Are you crazy? What about the mess you would create? (You can only put liquids inside of a Fuel Truck.)";};
